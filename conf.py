...
# BASE_URL = "http://campbellized.com/"
BLOG_EMAIL = "campbellized@gmail.com"
BLOG_DESCRIPTION = "The personal site of Chris Campbell"  # (translatable)
...
# (translatable)
CONTENT_FOOTER = '<p class="footer__content">Designed & built by <a href="mailto:{email}">{author}</a> &copy; {date}'
